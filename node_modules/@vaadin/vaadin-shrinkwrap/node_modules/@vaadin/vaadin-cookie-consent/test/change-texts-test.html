...
<test-fixture id="changed">
    <template>
        <vaadin-cookie-consent cookie-name="changetextscookie3" dismiss="custom-dismiss" learn-more="custom-learn-more"
                               learn-more-link="http://custom-learn-more-link/"
                               message="custom-message"></vaadin-cookie-consent>
    </template>
</test-fixture>
