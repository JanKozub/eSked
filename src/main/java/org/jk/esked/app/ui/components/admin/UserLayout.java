...
import org.jk.esked.app.ui.components.schedule.ScheduleGrid;
import org.jk.esked.app.ui.components.settings.fields.EmailField;
import org.jk.esked.app.ui.components.settings.fields.GroupCodeField;
...
public class UserLayout extends VerticalLayout {
    public UserLayout(User user, UserService userService, EmailService emailService, GroupService groupService,
        ...
        InfoBox createdDate = new InfoBox(getTranslation("user.created.date") + ": " + TimeService.instantToFormattedDate(user.getCreatedTimestamp()));
        InfoBox lastLoggedDate = new InfoBox(getTranslation("user.last.logged") + ": " + TimeService.instantToFormattedDate(user.getLastLoggedTimestamp()));
